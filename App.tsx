      ...
      <div className="relative flex-1 min-h-0">
        ...
        {view === GameView.HOME && !isAtBottom && globalMessages.length > 0 && (
          <button
            ...
            className="absolute bottom-4 right-4 w-10 h-10 bg-blue-600 hover:bg-blue-500 text-white rounded-full shadow-lg flex items-center justify-center transition-all active:scale-95 z-10"
            title="맨 아래로"
          >
            <ChevronDown size={24} />
          </button>
